-- The OTX Server Config
	...
	-- Owner Data
	ownerName = "Natanael Beckman"
	ownerEmail = "natanbeckman@live.com"
	url = "www.megatibia.com.br"
	location = "Brazil"

	-- Messages
	motd = "Welcome to the MegaTibia!"
	serverName = "MegaTibia"
	loginMessage = "Welcome to The MegaTibia!"
