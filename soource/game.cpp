...
std::string _text = asLowerCaseString(text);
   ...
   std::string words []= {"login", ".net", ".br", ".uk", ".tk", "dyndns", "omegaot", "universalots", "omegatibia", "omega", "servegame", "xodera", "wartoria", "tibia1", "no-ip", ".net", ".com", ".br", ".org", ".pl", ".eu", "resetar", "resetei", "resetado", "resetou", "resetando", "reseta", "reset", "reseted", "resete", "rezetar", "rezetado", "rezetou", "rezetando", "rezeta", "rezet", "rezeted", "rezete", "rezetei"};
   int ii, length;
